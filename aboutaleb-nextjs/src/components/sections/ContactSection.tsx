          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 border border-slate-200 rounded-xl font-cairo text-sm
                  focus:outline-none focus:border-[#C0392B] focus:ring-2 focus:ring-[#C0392B]/10 transition-all"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border border-slate-200 rounded-xl font-cairo text-sm bg-white
                  focus:outline-none focus:border-[#C0392B] focus:ring-2 focus:ring-[#C0392B]/10 transition-all"
              >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#C0392B] text-white py-3.5 rounded-xl font-black text-sm
                hover:bg-[#9a2e22] hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed
                transition-all shadow-[0_4px_15px_rgba(192,57,43,0.3)] flex items-center justify-center gap-2"
            >
              {loading && (
